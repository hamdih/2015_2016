...
{	
		...
		while(now != NULL)				
		{
			if( now->getID() == data)	// compare student name to searching name
			{		// found person 
				if(now->spouse != NULL)
				{
					cout<<now->getID();
					cout<<now->getName()<<endl;
					cout<<"+----------------------------+\n";
					cout<<"Parent ID: "<<now->getID()<<now->getName()<<"---";	
					cout<<"Spouse ID: "<<now->spouse->getID()<<now->spouse->getName()<<endl;
				}	
				if(now->child == NULL)
				{
					return;
				...
				{
					cout<<"     Child ID: "<<now->child->getID()<<now->child->getName();
					if(now->child->spouse == NULL)
					{
						cout<<endl;
					}
					else if(now->child->spouse !=NULL)
					{
						cout<<"---Spouse ID: "<<now->child->spouse->getID()<<now->child->spouse->getName()<<endl;	
					}	
					if(now->child->child != NULL)
					{
					cout<<"         Grand Child ID: "<<now->child->child->getID()<<now->child->child->getName();
						if(now->child->child->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child->child->spouse !=NULL)
						{
							cout<<"---Spouse ID: "<<now->child->child->spouse->getID()<<now->child->child->spouse->getName()<<endl;	
						}
					}
					if(now->child->child2 != NULL)
					{
					cout<<"         Grand Child ID :"<<now->child->child2->getID()<<now->child->child2->getName();
						if(now->child->child2->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child->child2->spouse !=NULL)
						{
							cout<<"---Spouse ID: "<<now->child->child2->spouse->getID()<<now->child->child2->spouse->getName()<<endl;	
						}
					}
					if(now->child->child3 != NULL)
					{
					cout<<"         Grand Child ID: "<<now->child->child3->getID()<<now->child->child3->getName();
						if(now->child->child3->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child->child3->spouse !=NULL)
						{
							cout<<"---Spouse ID: "<<now->child->child3->spouse->getID()<<now->child->child3->spouse->getName()<<endl;	
						}
					}
				}
				if(now->child2 == NULL)
				...
				else if(now->child2 != NULL)
				{
					cout<<"     Child ID: "<<now->child2->getID()<<now->child2->getName();
					if(now->child2->spouse == NULL)
					{
						cout<<endl;
					}
					else if(now->child2->spouse !=NULL)
					{
						cout<<"---Spouse ID: "<<now->child2->spouse->getID()<<now->child2->spouse->getName()<<endl;	
					}	

					if(now->child2->child != NULL)
					{
					cout<<"         Grand Child ID: "<<now->child2->child->getID()<<now->child2->child->getName();
						if(now->child2->child->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child2->child->spouse !=NULL)
						{
							cout<<"---Spouse ID: "<<now->child2->child->spouse->getID()<<now->child2->child->spouse->getName()<<endl;	
						}
					}
					if(now->child2->child2 != NULL)
					{
					cout<<"         Grand Child ID: "<<now->child2->child2->getID()<<now->child2->child2->getName();
						if(now->child2->child2->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child2->child2->spouse !=NULL)
						{
							cout<<"---Spouse ID:"<<now->child2->child2->spouse->getID()<<now->child2->child2->spouse->getName()<<endl;	
						}
					}
					if(now->child2->child3 != NULL)
					{
					cout<<"         Grand Child ID:"<<now->child2->child3->getID()<<now->child2->child3->getName();
						if(now->child2->child3->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child2->child3->spouse !=NULL)
						{
							cout<<"---Spouse ID:"<<now->child2->child3->spouse->getID()<<now->child2->child3->spouse->getName()<<endl;	
						}
					}
				}
				if(now->child3 == NULL)
				...
				else if(now->child3 != NULL)
				{
					cout<<"     Child ID:"<<now->child3->getID()<<now->child3->getName();
					if(now->child3->spouse == NULL)
					{
						cout<<endl;
					}
					else if(now->child3->spouse !=NULL)
					{
						cout<<"---Spouse ID:"<<now->child3->spouse->getID()<<now->child3->spouse->getName()<<endl;	
					}	

					if(now->child3->child != NULL)
					{
						cout<<"         Grand Child ID:"<<now->child3->child->getID()<<now->child3->child->getName();
						if(now->child3->child->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child3->child->spouse !=NULL)
						{
							cout<<"---Spouse ID:"<<now->child3->child->spouse->getID()<<now->child3->child->spouse->getName()<<endl;	
						}
					}
					if(now->child3->child2 != NULL)
					{
						cout<<"         Grand Child ID:"<<now->child3->child2->getID()<<now->child3->child2->getName();
						if(now->child3->child2->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child3->child2->spouse !=NULL)
						{
							cout<<"---Spouse ID:"<<now->child3->child2->spouse->getID()<<now->child3->child2->spouse->getName()<<endl;	
						}
					}
					if(now->child3->child3 != NULL)
					{
						cout<<"         Grand Child ID:"<<now->child3->child3->getID()<<now->child3->child3->getName();
						if(now->child3->child3->spouse == NULL)
						{
							cout<<endl;
						}
						else if(now->child3->child3->spouse !=NULL)
						{
							cout<<"---Spouse ID:"<<now->child3->child3->spouse->getID()<<now->child3->child3->spouse->getName()<<endl;	
						}
					}
				}
			else
...
cout<<"ftree <uid> ==> Print a Family Tree starting with the <uid> record"<<endl;
