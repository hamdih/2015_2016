...
{	
		...
		while(now != NULL)				
		{
			...
			cout<<now->getName()<<endl;
			cout<<"+----------------------------+\n";
			cout<<"|Parent ID:"<<now->getID()<<" "<<now->getName()<<"  |"<<endl;	
			cout<<"|Spouse ID:"<<now->spouse->getID()<<" "<<now->spouse->getName()<<"|\n";
			cout<<"+----------------------------+\n";	
			
				if(now->child != NULL)
				{
				
				cout<<"          |"<<endl<<"          |"<<endl<<"          |"<<endl<<"          |"<<endl<<"          V"<<endl;
				cout<<"+----------------------------+\n";
				cout<<"|ID:"<<now->child->getID()<<" "<<now->child->getName()<<"         |\n";
				cout<<"|Spouse ID:"<<now->child->spouse->getID()<<" "<<now->child->spouse->getName()<<" |\n";
				cout<<"+----------------------------+\n";	
				}	
				...
				cout<<"          |"<<endl<<"          |"<<endl<<"          |"<<endl<<"          |"<<endl<<"          V"<<endl;
				cout<<"+----------------------------+\n";
				cout<<"|ID:"<<now->child->child->getID()<<" "<<now->child->child->getName()<<"         |";
				cout<<"|Spouse ID:"<<now->child->child->spouse->getID()<<" "<<now->child->child->spouse->getName()<<" |\n";
				cout<<"+----------------------------+\n";	
				}
